...
<div id="content">
<a href="requisition_request.php" class="btn btn-info"> Go Back </a>
<br>
  <center>
   ...
   <?php
        ...
        if (isset($_REQUEST["forward_id"])) {
          // $bus_id = $_REQUEST["bus_id"];
          // $bus_name = $_REQUEST["bus_name"];
          // $bus_type = $_REQUEST["bus_type"];
          $confirm_vehicle = "";

            $editingID = $_REQUEST["forward_id"];
          ...
          if ($runquery==true) {
             ...
             echo "<span style='color:red'>The requistion request is forwarded to Super Admin!</span>";
          }
        }
...
if (isset($_REQUEST['view_id'])) {
 ...
 while($getData = mysqli_fetch_array($run_selectInfo)){ ?>
   <center>
        ...
        <a href="accept.php?accept_id=<?php echo $getData['id'];?>&bus_type=<?php echo $getData['bus_type'];?>" class="btn btn-success">Accept</a>
        <a onclick="return confirm('Are you sure?');" href="requisition_form_view.php?reject_id=<?php echo $getData['id'];?>" class="btn btn-info">Reject</a>
        <a onclick="return confirm('Are you sure?');" href="requisition_form_view.php?forward_id=<?php echo $getData['id'];?>" class="btn btn-danger">Forward</a> <br>
           ...
           //php mailer
               ...
               // //ad
                ...
                $rq_date = $info_date;
                         ...
                         $result = '<div>Sorry! Your vehicle requistion of '.$rq_date.' is Rejected for some special reasons. For more details, please click the link and login  <br>'.$url.'</div>';
                    ...
                    require 'PHPMailerAutoload.php';
                      ...
                      //  $mail->SMTPDebug = 3;
                        ...
                        $mail->setFrom('noreply@justvms.com', 'JUST VMS');
