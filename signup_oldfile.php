...
<?php
	if (isset($_POST['sub'])) {
        ...
        $url = 'http://'.$_SERVER['SERVER_NAME'].'/Just_JVMS_Final_24_01_2020/verify.php?id='.$last_id.'&token='.$authToken;
...
<!-- Php Operation Finish-->
			 ...
			 <?php if(isset($lnameLength)){echo $lnameLength;} ?> </span>
				...
				<form action=" " method="POST" style="width: 100%;background: #fff">
					...
					<input type="text" name="dept_section" class="form-control" required="1" placeholder="Department/Section" value="<?php if(isset($_POST['dept_section'])){echo $_POST['dept_section'];}?>"> <br>

					<input type="email" name="useremail" style="width: 80%" class="form-control" required="1" placeholder="Email" value="<?php if(isset($_POST['useremail'])){echo $_POST['useremail'];}?>">

						<br>
					<input type="number" name="number" style="width: 80%" class="form-control" required="1" placeholder="Mobile Number" value="<?php if(isset($_POST['number'])){echo $_POST['number'];}?>">
				...
				-->
					<input type="submit" class="form-control btn btn-dark" style="width: 80%"  name="sub" value="Sign Up">
					<br><br>
